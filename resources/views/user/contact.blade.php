...
<link href="{{asset('common/styelcontact.css')}}" rel="stylesheet">
...
<header>
    ...
    <div class="contect_first">
        <div class="container">
            <div class="row bw">
                <div class="col-md-3">
                    <h5>Contact us</h5>
                    <h2>Success Begins Here Get In Touch</h2>
                    ...
                    <div  class="title_contact">
                    <p><img src="img/ICON/Group 33.png" style="height:20px;width:20px;" alt=""> (+44) 55 500 00 15</p>
                    <p><img src="img/ICON/Group 35.png" style="height:20px;width:20px;" alt=""> hanoi@rikkeisoft.com</p>
                </div>
                <input type="button" class="btton" value="SEND INQUIRIES">

            </div>
                <div class="col-md-9">
                        <div class="row bw">
                            <div class="col">
                                <img src="img/Present/2-2.png" alt="">
                            </div>
                            <div class="col">
                                <img src="img/Present/2-3.png" alt="">
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <div class="container">
            <div class="row bw">
                <div class="col-md-8">
                    <div class="row bw">
                        <div class="col">
                            <img src="img/Present/Image 21.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <div class="contect_first">
        <div class="container">
            ...
            <div class="col-md-8">
                <div class="row bw">
                    <div class="col">
                        <img src="img/Present/Image 22.png" alt="">
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="container">
            <div class="row bw">
                <div class="col-md-8">
                    <div class="row bw">
                        <div class="col">
                            <img src="img/Present/Image 23.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
