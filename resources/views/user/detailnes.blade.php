...
<div class="container">
    <div id="app">
        <div class="float-right">
            ...
            <div class="panel-footer">
                <favorite :article={{ $article->id }} :favorited={{ $article->favorited() ? 'true' : 'false' }}>
                </favorite>
            </div>
            @endif
        </div>
        <div>
            <h1 class="mt-5">Title : {{$article->title}}</h1>
            <p>By {{$article->users['name']}}</p>
 ...
 <div class="col">
        <div class="item-wrapper">
            ...
            {{-- , $article->id --}}
            <form action="{{route('rating.store')}}" method="post" role="form">
            @csrf
            {{-- <div class="form-group">
                <label for="">Rating</label>
                <input type="text" class="form-control" name="rating" id="">
            </div> --}}
            <div class="rating">
...
// Are you include Chart JS in your project?
//yeah bro, can you show me ok

// This error mean, you CAN NOT write this script here
// Can you see? yea, Okay, i'll find another place to write bellow code

// OKay, i'm understand your problem
// For the first, you comment out chartJS -> uncomment it
// The second is you using a VueJS
// So inside you app, NOT ALLOW another script tag
// If you want using script tag, you must define  type="application/javascript" attribue in open tag.
// Do you understand? yeah but i not ever use VueJS ToT, let me find in your app
// Because I remember recently I help you about VueJS like/dislike component. Do you remember? yes
