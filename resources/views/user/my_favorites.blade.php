    ...
    <div class="row justify-content-md-center">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="content pt-15">
                <div class="card mb-3">
                    <a href="/article_show/{{$myFavorite->id}}">
                        <div class="row no-gutters text-dark">
                            <div class="col-md-4">
                                <img src="{{ asset($myFavorite->imagenews) }}" class="bd-placeholder-img" height="100%"
                                    alt="Imagenews">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{{$myFavorite->description}}</p>
                                    <p class="card-text"><small class="text-muted">{{$myFavorite->created_at}}</small>
                                    </p>
                                    @if (Auth::check())
                                    <div class="panel-footer">
                                        <favorite :article={{ $myFavorite->id }}
                                            :favorited={{ $myFavorite->favorited() ? 'true' : 'false' }}></favorite>
                                    </div>
                                    @endif
                                </div>
                            </div>
