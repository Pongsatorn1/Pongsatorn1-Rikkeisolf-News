...
<div class="container mt-3">
    ...
    <div class="jumbotron">
        <div class="row">
            <div class="col"> <strong >Images : </strong> <br>
                <img class="mt-3" src="<?php echo asset($user->avatar);  ?>" style="height:550px;width:550px; border-radius :50% "     alt=""> <br>
            </div>
            <div class="col">
                <div class="mt-5">
            ...
            <a href="{{ URL::to('user/' . $user->id)}}" type="button" class="btn btn-success mt-3">
                Edit Profile</a>
            </div>
